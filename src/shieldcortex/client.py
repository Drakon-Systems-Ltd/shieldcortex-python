...
class ShieldCortex:
    ...
    def report_threat(
        ...
        return self._post("/v1/threats", payload, ThreatReportResponse)
    ...
    def get_iron_dome_stats(
        ...
        *,
        ...
        return self._get("/v1/audit/iron-dome/stats", params, IronDomeStats)

    def get_iron_dome_events(
        self,
        *,
        time_range: Literal["24h", "7d", "30d"] = "24h",
        device_id: str | None = None,
    ...
    def ingest_audit_events(
        ...
        return self._post("/v1/audit/ingest", payload, AuditIngestResponse)
    ...
    def get_audit_export_manifest(self, manifest_id: str) -> ExportManifestDetail:
    ...
    def list_audit_export_verifications(
        self,
        manifest_id: str,
        *,
        limit: int = 50,
